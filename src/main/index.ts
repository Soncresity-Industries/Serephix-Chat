...
console.log("schat v" + app.getVersion());

// Make the Vencord files use our DATA_DIR
process.env.Soncresity_Industries_USER_DATA_DIR = DATA_DIR;
...
if (!app.requestSingleInstanceLock({ IS_DEV })) {
    if (IS_DEV) {
        console.log("schat is already running. Quitting previous instance...");
        init();
    } else {
        console.log("schat is already running. Quitting...");
        app.quit();
    }
} else {
    init();

...
function initTray(win: BrowserWindow) {
    ...
    const trayMenu = Menu.buildFromTemplate([
        ...
        {
            label: "Repair Soncresity Industries",
            async click() {
...
async function clearData(win: BrowserWindow) {
    const { response } = await dialog.showMessageBox(win, {
        message: "Are you sure you want to reset schat?",
        detail: "This will log you out, clear caches and reset all your settings!\n\nschat will automatically restart after this operation.",
        buttons: ["Yes", "No"],
...
function initMenuBar(win: BrowserWindow) {
    ...
    const subMenu = [
        ...
        {
            label: "Force Update Soncresity Industries",
            async click() {
                await downloadVencordAsar();
                app.relaunch();
                app.quit();
            },
            toolTip: "schat will automatically restart after this operation"
        },
        {
            label: "Reset schat",
            async click() {

...
const SettingsOptions: Record<string, Array<BooleanSetting | SettingsComponent>> = {
    ...
    "User Interface": [
        ...
        },
        {
            key: "staticTitle",
            title: "Static Title",
            description: 'Makes the window title "schat" instead of changing to the current page',
            defaultValue: false
        },
        {
            key: "enableMenu",
        ...
        },
        {
            ...
            description:
                "Shows a small splash screen while schat is loading. Disabling this option will show the main window earlier while it's still loading.",
            defaultValue: true
        },
        {
            key: "splashTheming",
    ...
    Tray: [
        ...
        TrayFillColorSwitch,
        {
            ...
            description: "Hitting X will make schat minimize to the tray instead of closing",
            defaultValue: true,
        ...
        },
        {
            ...
            description: "Left clicking tray icon will toggle the schat window visibility.",
            defaultValue: false,
    ...
    Miscellaneous: [
...

        {
            ...
            description: "Opens links in a new schat window instead of your web browser",
            defaultValue: false
        },
...
export default ErrorBoundary.wrap(
    ...
    {
        message:
            "Failed to render the schat Settings tab. If this issue persists, try to right click the schat tray icon, then click 'Repair Vencord'. And make sure your schat is up to date."
    }
);
